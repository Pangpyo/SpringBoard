...
CREATE TABLE `comment` (
  ...
  KEY `FKdo43crow250i16aof0wxm0u54` (`post_pk`),
  CONSTRAINT `FKdo43crow250i16aof0wxm0u54` FOREIGN KEY (`post_pk`) REFERENCES `post` (`post_pk`)
...
INSERT INTO `comment` VALUES (5,'2023-07-29 21:25:34.312000','작성자야','내용이야',1,4);
